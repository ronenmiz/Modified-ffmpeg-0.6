...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-shared --disable-static --enable-memalign-hack --enable-libmp3lame --target-os=mingw32 --arch=x86
prefix=/usr/local
...
SRC_PATH="/c/dev/ffmpeg/ffmpeg-0.6/src"
SRC_PATH_BARE=/c/dev/ffmpeg/ffmpeg-0.6/src
BUILD_ROOT="/c/dev/ffmpeg/ffmpeg-0.6/src"
ARCH=x86
CC=gcc
AS=gcc
LD=gcc
...
CFLAGS=   -std=c99 -fno-common -fomit-frame-pointer -g -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit -Werror=missing-prototypes
ASFLAGS=   -g
CC_O=-o $@
...
SHFLAGS=-shared -Wl,--output-def,$$(@:$(SLIBSUF)=.def) -Wl,--out-implib,$(SUBDIR)lib$(SLIBNAME:$(SLIBSUF)=.dll.a) -Wl,--enable-runtime-pseudo-reloc -Wl,--enable-auto-image-base -Wl,--version-script,$(SUBDIR)lib$(NAME).ver
...
EXTRALIBS=  -lpsapi -lm -lmp3lame -lm -lws2_32 -lavicap32
INSTALL=install
LIBTARGET=i386
